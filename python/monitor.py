...
def _read_temps():
    global _cached_cpu_temp, _cached_gpu_temp
...
def main():
    ...
    while True:
        ...
        try:
            ...
            data = {
                "cpu": cpu, "cpuFreq": cpu_freq, "cpuTemp": _cached_cpu_temp,
                "gpu": gpu_load, "gpuTemp": _cached_gpu_temp,
                "mem": mem, "disk": disk, "diskIO": disk_io
            }
